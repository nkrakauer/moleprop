CheckFeaturizer = {
    ...
    ## added on 2/17/2019
    ('flashpoint', 'tf_regression'): ['ECFP', 1024],
    ('flashpoint', 'rf_regression'): ['ECFP', 1024],
    ('flashpoint', 'krr'): ['ECFP', 1024],
    ('flashpoint', 'xgb_regression'): ['ECFP', 1024],
    ('flashpoint', 'graphconvreg'): ['GraphConv', 75],
    ('flashpoint', 'dag_regression'): ['GraphConv', 75],
    ('flashpoint', 'weave_regression'): ['Weave', 75],
    ('flashpoint', 'mpnn'): ['Weave', [75, 14]],
    ('flashpoint', 'textcnn_regression'): ['Raw', None],
    ## added on 2/17/2019
...
CheckSplit = {
    ...
    'flashpoint': ['index', 'random', 'scaffold'],  # added on 2/17/2019 by Xiaoyu Sun
