...
Modified by Xiaoyu Sun 2019/2/17
"""
...
def run_benchmark(datasets,
  ...
  datasets: list of string
      ...
      kinase, flashpoint #flashpoint is Xiaoyu-defined new dataset#
  ...
  for dataset in datasets:
    if dataset in [
      ...
      if metric == None:
        ...
        'nci', 'pdbbind', 'ppb', 'qm7', 'qm7b', 'qm8', 'qm9', 'sampl', 'flshpoint' ##'flashpoint' is added on 2/17/2019
    ]:
      mode = 'regression'
      if metric == None:
        metric = [
    ...
    loading_functions = {
        ...
        'flashpoint': deepchem.molnet.load_flashpoint,  ## added on 2/17/2019
...
def load_dataset(dataset, featurizer, split='random'):
  ...
  dataset_loading_functions = {
      ...
      'qm9': deepchem.molnet.load_qm9,
      'sampl': deepchem.molnet.load_sampl,
      'sampl': deepchem.molnet.load_flashpoint,  # Xiaoyu's modification for running flashpoint dataset
      'sider': deepchem.molnet.load_sider,
      'tox21': deepchem.molnet.load_tox21,
      'toxcast': deepchem.molnet.load_toxcast,
      'uv': deepchem.molnet.load_uv
