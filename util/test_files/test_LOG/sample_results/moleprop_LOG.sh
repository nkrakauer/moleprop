...
#SBATCH --error=~/Moleprop/summer19/test_LOG/model-%j.err
#SBATCH --output=~/Moleprop/summer19/test_LOG/model-%j.out
...
python ~/Moleprop/summer19/util/test_LOG/test_LOG.py
