...
#SBATCH --error=~/Moleprop/summer19/test_multi_cv/model-%j.err
#SBATCH --output=~/Moleprop/summer19/test_multi_cv/model-%j.out
...
python ~/Moleprop/summer19/util/test_multi_cv/test_multi_cv.py
