...
#SBATCH --error=/srv/home/nkrakauer/moleprop/util/optimization/out-%j.err
#SBATCH --output=/srv/home/nkrakauer/moleprop/util/optimization/out-%j.out
...
python /srv/home/nkrakauer/moleprop/util/optimization/grid_optimizer.py
