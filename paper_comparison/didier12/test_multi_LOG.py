...
print("About to load")
loader = wf.Loader
data = loader.load(file_name = 'didier12.csv',data_dir = '/srv/home/nkrakauer/moleprop/data')
...
for r in range(repetition):
    ...
    scores,pred,test_dataset = wf.Run.LOG_validation(data,ind, model ='MPNN',model_args = args, metrics = ['AAD', 'RMSE', 'MAE', 'R2'])
