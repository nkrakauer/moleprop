...
#SBATCH --gres=gpu:1
#SBATCH -t 3-01:30 # time (D-HH:MM)

## Create a unique output file for the job
#SBATCH --error=/srv/home/xsun256//paper_comparison/godinho11/optimization/opt-carl10-%j.err
#SBATCH --output=/srv/home/xsun256//paper_comparison/godinho11/optimization/opt-carl10-%j.out
...
python /srv/home/xsun256/paper_comparison/godinho11/optimization/opt.py
