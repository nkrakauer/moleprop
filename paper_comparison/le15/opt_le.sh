...
##SBATCH --gres=gpu:1
#SBATCH -t 6-01:30 # time (D-HH:MM)

## Create a unique output file for the job
#SBATCH --error=/srv/home/nkrakauer/moleprop/paper_comparison/le15/le-%j.err
#SBATCH --output=/srv/home/nkrakauer/moleprop/paper_comparison/le15/le-%j.out
...
python /srv/home/nkrakauer/moleprop/paper_comparison/le15/test.py
